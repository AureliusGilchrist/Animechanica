...
func (pm *PlaybackManager) handleTrackingStarted(status *mediaplayer.PlaybackStatus) {
	...
	// Send event to the client that initiated playback
	...
	if err != nil {
		...
		// Send error event to the client that initiated playback
...
func (pm *PlaybackManager) handlePlaybackStatus(status *mediaplayer.PlaybackStatus) {
	...
	// Send the playback state to the client that initiated playback
