 ...
 */
export type RemoveMangaChaptersFromQueue_Variables = {
    downloadIds: Array<ChapterDownloader_DownloadID>
}
...
/**
 * - Filepath: internal/handlers/manga_to_read.go
 * - Filename: manga_to_read.go
 * - Endpoint: /api/v1/manga/to-read
 * @description
 * Route adds a manga to the to-read list.
 */
export type AddMangaToReadItem_Variables = {
    mediaId: number
}
 ...
 */
export type RemoveMangaToReadItem_Variables = {
    mediaId: number
}
 ...
 */
export type IsMangaInToReadList_Variables = {
    mediaId: number
}
