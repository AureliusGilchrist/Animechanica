...
export function VideoCore(props: VideoCoreProps) {
    ...
    const handleTimeUpdate = (e: React.SyntheticEvent<HTMLVideoElement>) => {
        ...
        const completionThreshold = serverStatus?.settings?.library?.progressUpdateThreshold || 0.8
        if (!!v.duration && !videoCompletedRef.current && percent >= completionThreshold) {
